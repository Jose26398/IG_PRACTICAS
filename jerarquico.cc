...
void ObjJerarquico::draw( const int modo_vis, const bool usar_diferido, int valor,
                          bool sel_dibujada, bool obj_sel[]) //ModoVis
{
   assert( objparam != nullptr );
   objparam->draw( modo_vis, usar_diferido, valor, sel_dibujada, obj_sel );
}
